...
//	}
	...
	public static boolean addNewProduct(String nume, double pret, String tip) { 
		
		if(!tip.equals("Zona") && !tip.equals("Bar") && !tip.equals("Restaurant") && !tip.equals("Servicii")) {
			return false;
		}
		
		String query = "INSERT INTO produse ( Nume, Pret, Tip)" + "values(?,?,?)";
